  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://authenticationagency.onrender.com/register",
        formData,
        {
            ...
            <div className="ts-register-header">
              ...
              <div className="ts-progress-container">
                ...
                <div className="ts-step-indicators">
                  <div
                    className={`ts-step-circle ${
                      currentStep >= 1 ? "ts-active" : ""
                    }`}
                  >
                    1
                  </div>
                ...
                <div className="ts-step-labels">
                  <span className={currentStep === 1 ? "ts-current-step" : ""}>
                    Account Info
                  </span>
                  <span className={currentStep === 2 ? "ts-current-step" : ""}>
                    Contact & Security
                  </span>
                </div>
              </div>
                ...
                <div className="ts-form-step ts-step-1">
                  <div className="ts-form-group">
                    ...
                    <input
                      ...
                      className={`${
                        errors.username || usernameError ? "ts-input-error" : ""
                      }`}
                  ...
                  <div className="ts-form-group">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`${
                        errors.email || emailError ? "ts-input-error" : ""
                      }`}
              ...
              {currentStep === 2 && (
                <div className="ts-form-step ts-step-2">
                  <div className="ts-form-group">
                    ...
                    />
                    {errors.contacts && (
                      <div className="ts-error-message">{errors.contacts}</div>
                    )}
                  </div>
                  ...
                  <div className="ts-form-group">
                    ...
                    />
                    {errors.password && (
                      <div className="ts-error-message">{errors.password}</div>
                    )}
